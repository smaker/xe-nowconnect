...
class Mobile_Detect
{
	...
	protected static $utilities = array(
		...
		'WebKit'	  => '(webkit)[ /]([\w.]+)',
		'Bot'		 => 'Googlebot|DoCoMo|YandexBot|bingbot|ia_archiver|AhrefsBot|Ezooms|GSLFbot|WBSearchBot|Twitterbot|TweetmemeBot|Twikle|PaperLiBot|Wotbox|UnwindFetchor|facebookexternalhit|Naverbot|Yeti|Baiduspider|msnbot|bingbot|yahoo',
